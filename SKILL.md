...
2. A publication-grade **12-page Japanese Zakka A4 Print Journal (PDF)**.
...
- Determine driving constraints (left-side road rules, mountain passes, max 4-5 hours driving/day).
- Ingest lodging requirements, must-visit culinary targets, and must-book activities.

### Runbook 2: Day-by-Day Schedule & Pacing Optimization
- Structure days with exact timestamps, route mileage, driving durations, and daylight windows (~20:50 sunset in Nov).
- Balance sightseeing with dining spotlights (signature dish, pricing, hours, booking links) and luxury hotel reviews.
...
- Compile `interactive_travel_map.html` featuring:
  - **Triple-View Switcher**: `🗺️ 互動地圖`, `📖 手帳在線預覽`, `📑 雙欄對照`.
  - **Day-by-Day Route Polylines**: Specific highways (SH73, SH6, SH94, Crown Range 1121m, etc.) with mileage badges.
  - **Side Drawer**: Spot cards with direct `[📍 Google Maps 導航]` links.
